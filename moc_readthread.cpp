...
QT_MOC_LITERAL(4, 26, 11), // "SendChatmsg"
QT_MOC_LITERAL(5, 38, 8), // "CHATMSG*"
QT_MOC_LITERAL(6, 47, 7) // "chatmsg"

    },
    "ReadThread\0SendSign\0\0flag\0SendChatmsg\0"
    "CHATMSG*\0chatmsg"
};
...
void ReadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->SendChatmsg((*reinterpret_cast< CHATMSG*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReadThread::SendChatmsg)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ReadThread::SendChatmsg(CHATMSG * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
